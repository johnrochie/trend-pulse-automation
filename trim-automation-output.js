#!/usr/bin/env node
/**
 * Standalone script to trim automation-output.json
 * Run this after articles are generated but before GitHub push
 */

const fs = require('fs').promises;
const path = require('path');

async function trimAutomationOutput() {
  const repoPath = process.env.GITHUB_REPO_PATH || '/home/jr/.openclaw/workspace/trend-pulse';
  const filePath = path.join(repoPath, 'automation-output.json');
